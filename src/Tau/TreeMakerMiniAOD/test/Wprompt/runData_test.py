...
process.source = cms.Source("PoolSource",
    ...
    'root://cms-xrd-global.cern.ch//store/data/Run2017B/MET/MINIAOD/31Mar2018-v1/100000/2226ADB0-2E37-E811-90E2-008CFAC93D1C.root'
    ),
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('Data_MET_2017_94X.root')
)
