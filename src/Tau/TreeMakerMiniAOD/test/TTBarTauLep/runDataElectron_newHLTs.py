...
process.source = cms.Source("PoolSource",
    ...
    # 'root://cms-xrd-global.cern.ch//store/data/Run2016C/SingleElectron/MINIAOD/17Jul2018-v1/00000/162D174D-318D-E811-9389-0242AC130002.root'
    ),
...
process.TTbarTauLepton = cms.EDAnalyzer("TTbarTauLepton",
    ...
    requiredLeptonPDGID = cms.int32(11),
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('Data_SingleElectron_Njets2.root')
)
