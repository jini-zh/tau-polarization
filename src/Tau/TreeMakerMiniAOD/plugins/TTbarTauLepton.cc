...
void TTbarTauLepton::beginJob() {
    ...
    tree->Branch("lepton1_electron_ecalTrkEnergyPostCorr", &lepton1_electron_ecalTrkEnergyPostCorr, "lepton1_electron_ecalTrkEnergyPostCorr/I");
    tree->Branch("lepton1_electron_ecalTrkEnergyErrPostCorr", &lepton1_electron_ecalTrkEnergyErrPostCorr, "lepton1_electron_ecalTrkEnergyErrPostCorr/I");
    // muon
    ...
    tree->Branch("lepton2_electron_ecalTrkEnergyPostCorr", &lepton2_electron_ecalTrkEnergyPostCorr, "lepton2_electron_ecalTrkEnergyPostCorr/I");
    tree->Branch("lepton2_electron_ecalTrkEnergyErrPostCorr", &lepton2_electron_ecalTrkEnergyErrPostCorr, "lepton2_electron_ecalTrkEnergyErrPostCorr/I");
    // muon
...
void TTbarTauLepton::GetMuonSF (const edm::Event& iEvent) {
    ...
    if (monitoringLeptons) {
        std::cout << "Muon 1 scale factor = " << lepton1_muon_SF << std::endl;
    }
}
*/
