...
process.source = cms.Source("PoolSource",
  ...
  #  'root://cms-xrd-global.cern.ch//store/data/Run2016B/JetHT/AOD/22Feb2017_ver2-v1/00000/00335C56-32FA-E611-B230-0025905B85F6.root'
	...
	'/store/data/Run2017D/JetHT/AOD/09Aug2019_UL2017-v1/50000/FCA065D9-004F-B04B-B377-2DE0ABA6E53D.root'
...
process.treemaker = cms.EDAnalyzer("TreeMaker",
							...
							CHSjetCollection = cms.string("ak4PFJetsCHS"),
							ak4JetTracksAssociatorAtVertexPF = cms.InputTag("ak4JetTracksAssociatorAtVertexPF"),
							trackRefsForJets = cms.InputTag("trackRefsForJets", ""),
                                                        pfDeepCSVJetTags_b = cms.InputTag("pfDeepCSVJetTags", 'probb'),
                                                        pfDeepCSVJetTags_bb = cms.InputTag("pfDeepCSVJetTags", 'probbb'),
                                                        METcut = cms.double(0),
                                                        MediumIsoCut = cms.bool(True),
							...
							pfTauDMFindingDiscriminator = cms.string("pfTausDiscriminationByDecayModeFinding"),
							hpspfTauDMFindingDiscriminator = cms.string("hpsPFTauDiscriminationByDecayModeFinding"),
							hpspfTauDMFindingDiscriminatorNewDMs = cms.string("hpsPFTauDiscriminationByDecayModeFindingNewDMs"),							hpspfTauDMFindingDiscriminatorOldDMs = cms.string("hpsPFTauDiscriminationByDecayModeFindingOldDMs"),
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string(
                       ...
                       'TreeMaker_JetHT_2017D-v1_UL.root'
  )
)
